...
function shout_macro_layout(){
    ...
    $('#nm_shout_macro .template_box.box1').append('　<label for="template_1"><input type="radio" name="template_type" id="template_1" value="template_1" checked>已记录＋时间排序</label><br>')
    $('#nm_shout_macro .template_box.box1').append('　<label for="template_2"><input type="radio" name="template_type" id="template_2" value="template_2">全部＋时间排序</label><br>')
    $('#nm_shout_macro .template_box.box1').append('　<label for="template_3"><input type="radio" name="template_type" id="template_3" value="template_3">已记录＋EL排序</label><br>')
    $('#nm_shout_macro .template_box.box1').append('　<label for="template_4"><input type="radio" name="template_type" id="template_4" value="template_4">全部＋EL排序</label><br>')
    $('#nm_shout_macro').append('<div class="template_box box2"></div>')
    $('#nm_shout_macro .template_box.box2').append('　<label for="chat_1"><input type="radio" name="chat_type" id="chat_1" value="chat_1" checked>纯文本</label><br>')
    $('#nm_shout_macro .template_box.box2').append('　<label for="chat_2"><input type="radio" name="chat_type" id="chat_2" value="chat_2">喊话频道</label><br>')
    // $('#nm_shout_macro .template_box.box2').append('　<label for="chat_3"><input type="radio" name="chat_type" id="chat_3" value="chat_3">接力模式</label><br>')
    $('#nm_shout_macro').append('<a id="make_macro_btn" class="btn_M center">生成</a>')
    $('#nm_shout_macro').append('<a id="copy_textarea_btn" class="btn_M center">复制</a><br>')
    $('#nm_shout_macro').append('<textarea class="shout_macro_text">点击“生成”后，将会以预览的数据为基础生成文本。例如：\n\n仙人掌[00:00]、章鱼[01:01]、鸟人[03:03]、蜻蜓[05:05]、巨熊[07:07]、群偶[09:09]、台风[11:11]、暴龙[13:13]、席兹[15:15]、贪吃鬼[17:17]、皮皮虾[19:19]\n\n粘贴进文本框后，点击“导入”按钮可将数据导入网页。（现在点击导入即可体验）</textarea><br>')
